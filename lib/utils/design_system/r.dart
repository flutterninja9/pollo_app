...
class R {
  ...
  // constants
  static final Constant constant = Constant.instance;
  // drawables
  static final Drawable drawable = Drawable.instance;
  // strings
  static final Strings strings = Strings.instance;
  // dimens
  static final Dimen dimen = Dimen.instance;
  // colors
  static final PColor color = PColor.instance;
  // fonts
  static final PFont font = PFont.instance;
}
