...
class ComputerEducationScreen extends StatelessWidget {
  static const routeName = "/computer-eduction";
  const ComputerEducationScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return MultiBlocProvider(providers: [
      BlocProvider(create: (context) => di<StateSelectionCubit>())
    ], child: const ComputerEducationScreenView());
  }
}

class ComputerEducationScreenView extends StatefulWidget {
  const ComputerEducationScreenView({super.key});

  @override
  State<ComputerEducationScreenView> createState() =>
      _ComputerEducationScreenViewState();
}

class _ComputerEducationScreenViewState
    extends State<ComputerEducationScreenView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
