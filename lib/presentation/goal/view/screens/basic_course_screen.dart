...
class BasicCourseScreen extends StatelessWidget {
  static const routeName = "/basic-course";
  const BasicCourseScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return MultiBlocProvider(providers: [
      BlocProvider(create: (context) => di<StateSelectionCubit>())
    ], child: const BasicCourseScreenView());
  }
}

class BasicCourseScreenView extends StatefulWidget {
  const BasicCourseScreenView({super.key});

  @override
  State<BasicCourseScreenView> createState() => _BasicCourseScreenViewState();
}

class _BasicCourseScreenViewState extends State<BasicCourseScreenView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
